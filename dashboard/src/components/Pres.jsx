...
const PresForm = () => {
    ...
    useEffect(() => {
        const getPres = async () => {
            try {
                const data = await axios.get("http://localhost:4000/api/v1/pres/getPres",
    ...
    const handlePres = async (e) => {
        e.preventDefault();
        try {
            const { data } = await axios.post("http://localhost:4000/api/v1/pres/postPres",
                {
                    firstName,
                    lastName,
                    phone,
            ...
            <section className='page pres'>
                <div>
                    <div className="container form-component appointment-form">
                        <h1 style={{ marginBottom: "20px", padding: "10px" }}>PRESCRIPTIONS</h1>
